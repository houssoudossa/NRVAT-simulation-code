...
#Y=read.table(file ="C:/Users/user/Dropbox/ClusteredBinaryGenetecTest/Programmes/simulate3/pedfile.dat")
#G=Get.G(Y[,-c(1:9)])
#Y=read.table(file ="C:/Users/user/Desktop/Simulate/pedfile.dat")
#G=Get.G(Y[,-c(1:9)])
